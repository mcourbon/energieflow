...
// Vérifier si on est côté client avant d'enregistrer le plugin
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center mt-16">
          ...
          >
            ...
            <Link 
              href="/seances"
              className="inline-block bg-white text-green-600 font-semibold px-8 py-3 rounded-full hover:bg-green-50 transition-colors shadow-lg"
            >
